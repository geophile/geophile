...
import com.geophile.index.Index;
...
/**
 * A {@link SpatialIndex} organizes a set of {@link com.geophile.spatialobject.SpatialObject}s for the efficient execution of spatial searches.
 * Spatial objects may be added to the spatial index by {@link SpatialIndex#add(com.geophile.spatialobject.SpatialObject)}, and removed by
 * {@link SpatialIndex#remove(com.geophile.spatialobject.SpatialObject)}. Spatial search is implemented
 * by {@link SpatialIndex#overlapping(com.geophile.spatialobject.SpatialObject, SpatialIndex.Duplicates)} which returns a
 * {@link com.geophile.index.Cursor} that will provide access to the spatial objects overlapping the given query object.
 * @param <SPATIAL_OBJECT> The type of {@link com.geophile.spatialobject.SpatialObject} contained by this spatial index.
 */
...
public abstract class SpatialIndex<SPATIAL_OBJECT extends SpatialObject>
{
     ...
     * @param index The {@link com.geophile.index.Index} that will store the indexed {@link SpatialObject}s.
     */
